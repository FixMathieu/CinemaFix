...
public void generateValues() {
	...
	City toulouseCentre=cityRepository.save(new City(null,"route du centre","obelix",toulouse,"toulouse.jpg"));
	City toulouseNord=cityRepository.save(new City(null,"chemin du Nord","panoramix",toulouse,"toulouse.jpg"));
	City toulouseSud=cityRepository.save(new City(null,"Boulevard du Sud","abraracourcix",toulouse,"toulouse.jpg"));
	City toulouseEst=cityRepository.save(new City(null,"impasse du Est","idefix",toulouse,"toulouse.jpg"));
	
	
	City bordeauxGare=cityRepository.save(new City(null,"rue Sainte Catherine","asterix",bordeaux,"bordeaux.jpg"));
	City bordeauxCentre=cityRepository.save(new City(null,"route du centre","obelix",bordeaux,"bordeaux.jpg"));
	City bordeauxNord=cityRepository.save(new City(null,"chemin du Nord","panoramix",bordeaux,"bordeaux.jpg"));
	City bordeauxSud=cityRepository.save(new City(null,"Boulevard du Sud","abraracourcix",bordeaux,"bordeaux.jpg"));
	...
	City marseilleGare=cityRepository.save(new City(null,"gare de Marseille","asterix",marseille,"marseille.jpg"));
	City marseilleCentre=cityRepository.save(new City(null,"route du centre","obelix",marseille,"marseille.jpg"));
	City marseilleNord=cityRepository.save(new City(null,"chemin du Nord","panoramix",marseille,"marseille.jpg"));
	City marseilleSud=cityRepository.save(new City(null,"Boulevard du Sud","abraracourcix",marseille,"marseille.jpg"));
	City marseilleEst=cityRepository.save(new City(null,"impasse du Est","idefix",marseille,"marseille.jpg"));
	
	
	Movie film1=movieRepository.save(new Movie(null,"StarWars",null));
	Movie film2=movieRepository.save(new Movie(null,"Harry potter",null));
	Movie film3=movieRepository.save(new Movie(null,"Jurassic World",null));
	Movie film4=movieRepository.save(new Movie(null,"Terminator",null));
	Movie film5=movieRepository.save(new Movie(null,"Alien",null));
	Movie film6=movieRepository.save(new Movie(null,"Thor",null));
	Movie film7=movieRepository.save(new Movie(null,"Iron Man",null));
	Movie film8=movieRepository.save(new Movie(null,"Hulk",null));
	Movie film9=movieRepository.save(new Movie(null,"Le seigneur des anneaux",null));
	Movie film10=movieRepository.save(new Movie(null,"Gladiator",null));
	Movie film11=movieRepository.save(new Movie(null,"Top Gun",null));
